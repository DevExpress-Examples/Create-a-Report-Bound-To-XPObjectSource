...
Namespace Create_a_Report_Bound_to_XPObjectSource.nwind
    ...
    Public Module ConnectionHelper
        ...
        Public Sub Connect(ByVal autoCreateOption As DevExpress.Xpo.DB.AutoCreateOption, ByVal Optional threadSafe As Boolean = False)
            If threadSafe Then
        ...
        Public Function GetConnectionProvider(ByVal autoCreateOption As DevExpress.Xpo.DB.AutoCreateOption, <Out> ByRef objectsToDisposeOnDisconnect As IDisposable()) As DevExpress.Xpo.DB.IDataStore
