...
Namespace Create_a_Report_Bound_to_XPObjectSource
    ...
    Public Partial Class Form1
        ...
        Private Sub simpleButton4_Click(ByVal sender As Object, ByVal e As EventArgs)
            ...
            AddHandler dataSource.ResolveSession, New EventHandler(Of ResolveSessionEventArgs)(AddressOf OnResolveSession)
            AddHandler dataSource.DismissSession, New EventHandler(Of ResolveSessionEventArgs)(AddressOf OnDismissSession)
            Dim printTool As ReportPrintTool = New ReportPrintTool(report)
            printTool.ShowPreviewDialog()
        End Sub
        ...
        Private Sub OnResolveSession(ByVal sender As Object, ByVal e As ResolveSessionEventArgs)
            ...
            If DataLayerInstance Is Nothing Then
                ...
                DataLayerInstance = XpoDefault.GetDataLayer(connectionString, DB.AutoCreateOption.SchemaAlreadyExists)
            End If
